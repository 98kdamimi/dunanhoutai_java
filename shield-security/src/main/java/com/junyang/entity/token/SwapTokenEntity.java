...
@Data
@Document(collection = "swaptokens")
...
public class SwapTokenEntity {
	...
	@TableField("onramperId")
	@ApiModelProperty(name = "onramperId", value = "", required = false, dataType = "String")
	private String onramperId;
	
	@TableField("onramperbuy")
	@ApiModelProperty(name = "onramperbuy", value = "", required = false, dataType = "boolean")
	private boolean onramperbuy;
	
	@TableField("onrampersell")
	@ApiModelProperty(name = "onrampersell", value = "", required = false, dataType = "boolean")
	private boolean onrampersell;
